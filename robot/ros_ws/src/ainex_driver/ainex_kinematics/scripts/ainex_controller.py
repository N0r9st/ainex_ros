...
class Controller:
    ...
    def move_to_init_pose(self):
        # 读取当前舵机角度和记录的角度进行比较，判断是否需要初始化姿态
        self.init_pose_finish = False
    ...
    def set_app_walking_param_callback(self, msg):
        ...
        if msg.speed == 4:
            ...
            if self.walking_param['x_move_amplitude'] != 0:
                ...
                if self.walking_param['x_move_amplitude'] > 0:
                    self.walking_param['angle_move_amplitude'] += 0.29
                else:
                    self.walking_param['angle_move_amplitude'] += 0.5
            ...
            if self.walking_param['y_move_amplitude'] != 0 and self.walking_param['x_move_amplitude'] == 0 and self.walking_param['angle_move_amplitude'] == 0:
                ...
                if self.walking_param['y_move_amplitude'] > 0:
                    self.walking_param['angle_move_amplitude'] += 0.59
                else:
                    self.walking_param['angle_move_amplitude'] += -0.6
        ...
        # print(self.walking_param['x_move_amplitude'], self.walking_param['y_move_amplitude'], self.walking_param['angle_move_amplitude'], self.walking_param['y_swap_amplitude'], self.walking_param['init_pitch_offset'], self.walking_param['init_y_offset'])
